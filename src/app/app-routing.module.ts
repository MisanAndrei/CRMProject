...
{ path: 'EditareElement/:id', component: UpsertElementComponent, canActivate: [AuthGuard]},
...
{ path: 'EditareFactura/:id', component: BillUpsertComponent, canActivate: [AuthGuard]},
...
{ path: 'EditareTranzactie/:id', component: TransactionsComponent, canActivate: [AuthGuard]},
...
{ path: 'EditareTransfer/:id', component: TransferUpsertComponent, canActivate: [AuthGuard]},
...
{ path: 'EditareCont/:id', component: AccountUpsertComponent, canActivate: [AuthGuard]},
{ path: 'PartenerNou', component: PartnerUpsertComponent, canActivate: [AuthGuard]},
{ path: 'EditarePartener/:id', component: PartnerUpsertComponent, canActivate: [AuthGuard]},
...
{ path: 'EditareTaxa/:id', component: TaxesUpsertComponent, canActivate: [AuthGuard]},
